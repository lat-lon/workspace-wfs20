...
function createDump {
 pg_dump -t osm_protected_area_seq -t osm_administrative_seq -t osm_protected_area -t osm_administrative -t gns_iceland_seq -t gns_iceland iceland_dump_base -f ../data/iceland-latest.dump
} 
