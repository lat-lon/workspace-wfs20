...
ALTER TABLE osm_administrative ADD COLUMN gml_identifier_codespace varchar;
...
CREATE OR REPLACE RULE insert AS
    ON INSERT TO osm_administrative_version DO INSTEAD  INSERT INTO versions.public_osm_administrative_version_log (id, osm_id, admin_level, name, place, osm_timestamp, way_area, geometry, gml_description, gml_identifier, gml_identifier_codespace, gml_name, place_attr_nil, place_attr_nilreason, osm_timestamp_modified_id, osm_timestamp_modified, action)
  VALUES (new.id, new.osm_id, new.admin_level, new.name, new.place, new.osm_timestamp, new.way_area, new.geometry, new.gml_description, new.gml_identifier, new.gml_identifier_codespace, new.gml_name, new.place_attr_nil, new.place_attr_nilreason, new.osm_timestamp_modified_id, new.osm_timestamp_modified, 'insert'::character varying)
  RETURNING public_osm_administrative_version_log.id,
    ...
    public_osm_administrative_version_log.gml_identifier_codespace,
